...
Shader "Cognition/HealthIndicator"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 _fullHealth = float4(0,0.2965517,1,0);
			...
			float clampResult35 = clamp( ( tex2DNode3.r * pow( (-0.8 + (atan2( break28.y , break28.x ) - (-4 + (( 1.0 - _health ) - 0) * (3.2 - -4) / (1 - 0))) * (1 - -0.8) / (5 - (-4 + (( 1.0 - _health ) - 0) * (3.2 - -4) / (1 - 0)))) , 0.01 ) ) , 0 , 1 );
...
/*ASEBEGIN
Version=15201
81;89;1425;715;2756.23;65.69003;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;6;-2005.539,240.5472;Float;False;Constant;_fullHealth;_fullHealth;1;0;Create;True;0;0;False;0;0,0.2965517,1,0;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A985FAE1250BF366A209894AFA0B2276AC15191E