...
Shader "Cognition/HealthIndicator"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult35 = clamp( ( tex2DNode3.r * pow( (-0.8 + (atan2( break28.y , break28.x ) - (-4 + (( 1.0 - (0.215 + (_health - 0) * (1 - 0.215) / (1 - 0)) ) - 0) * (3.2 - -4) / (1 - 0))) * (1 - -0.8) / (5 - (-4 + (( 1.0 - (0.215 + (_health - 0) * (1 - 0.215) / (1 - 0)) ) - 0) * (3.2 - -4) / (1 - 0)))) , 0.01 ) ) , 0 , 1 );
...
/*ASEBEGIN
Version=15201
56;70;1425;715;2638.345;-39.94385;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-3454.717,319.7953;Float;False;Property;_health;health;1;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;36;-3281.431,941.6873;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.215;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;6;-2005.539,240.5472;Float;False;Constant;_fullHealth;_fullHealth;1;0;Create;True;0;0;False;0;0.647,0.7720588,0,0;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;2;-59.19708,753.939;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;Cognition/HealthIndicator;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;0;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;-1;False;-1;-1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;0;0;0;False;-1;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=0AA33619196FD947C515BFC7C4D8C731641C3DC8